function res = assemble_diffusion_aux_bdr_jmp_pos(par, dg, dim, hx)
%ASSEMBLE_DIFFUSION_AUX_BDR_JMP_POS Boundary effects of jump 
% on the diffusion matrix for an auxiliary variable using positive flux.
%
%   Syntax:
%      res = assemble_diffusion_aux_bdr_jmp_pos(par, dg, dim, hx)
%
%   Inputs:
