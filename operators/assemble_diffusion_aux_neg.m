function res = assemble_diffusion_aux_neg(par, ref, dim, hx)
%ASSEMBLE_DIFFUSION_AUX_NEG Assemble diffusion matrix for an auxiliary 
...
%
%   Syntax:
%      res = assemble_diffusion_aux_neg(par, ref, dim, hx)
%
%   Inputs:
