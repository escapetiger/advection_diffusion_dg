function res = assemble_diffusion_aux_bdr_ext_ctr(par, dg, dim, hx)
%ASSEMBLE_DIFFUSION_AUX_BDR_EXT_CTR Boundary effects of extraction 
...
%   an auxiliary variable introduced by extraction, when using central 
%   flux along the specific dimension.
%   
%   Syntax:
%      res = assemble_diffusion_aux_bdr_ext_ctr(par, dg, dim, hx)
%
%   Inputs:
