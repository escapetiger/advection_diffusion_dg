function res = assemble_diffusion_aux_pos(par, ref, dim, hx)
%ASSEMBLE_DIFFUSION_AUX_POS Assemble diffusion matrix for an auxiliary 
...
%
%   Syntax:
%      res = assemble_diffusion_aux_pos(par, ref, dim, hx)
%
%   Inputs:
